...
_G.packer_plugins = {
  ...
  ["glow.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/ahwx/.local/share/nvim/site/pack/packer/opt/glow.nvim",
  ...
  install = {
    loaded = true,
    path = "/home/ahwx/.local/share/nvim/site/pack/packer/start/install",
    url = "https://github.com/install"
  },
  ["mason.nvim"] = {
